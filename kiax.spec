...
telefonem) pozwalającym użytkownikom PC wykonywać zwykłe połączenia
VoIP do serwerów Asteriska tak, jakby działo się to ze sprzętowymi
telefonami. Celem pakietu jest prosty i przyjazny dla użytkownika
graficzny interfejs. To jest - prosty do użycia klient IAX.
